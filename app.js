...
let db,selectedYear=new Date().getFullYear(),currentPage=1,paymentContext=null,editingPackageId=null,editingCustomerId=null;
...
$("savePaymentBtn").onclick=savePaymentFn;$("deletePaymentBtn").onclick=deletePaymentFn;$("closePaymentBtn").onclick=()=>$("paymentModal").classList.remove("show");$("closeCustomerBtn").onclick=()=>$("customerModal").classList.remove("show");$("editCustomerBtn").onclick=()=>{if(editingCustomerId)openEditCustomer(editingCustomerId)};$("closeEditCustomerBtn").onclick=()=>$("editCustomerModal").classList.remove("show");$("saveEditCustomerBtn").onclick=saveEditCustomer;
...
[$("paymentModal"),$("customerModal"),$("editCustomerModal"),$("editPackageModal"),$("restoreModal")].forEach(m=>m.addEventListener("click",e=>{if(e.target===m)m.classList.remove("show")}));
